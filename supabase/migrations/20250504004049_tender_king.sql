/*
  ...
  1. New Columns
    ...
    - login_count: Track number of times user has logged in
    - account_status: Track if account is active/inactive
    - account_type: Track user subscription level
    - metadata: Store additional user data as JSON

  2. Changes
    - Add new columns with appropriate data types and constraints
    - Set default values for new columns
    - Add check constraints for status and type fields
*/
